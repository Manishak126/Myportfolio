  ...
  return (
    ...
    {toggle?(
      ...
      <div className="side-nav">
            <div className="nav-link">
            <Link to="home" spy={true} smooth={true} offset={-100} duration={100}>
                <FcHome title='Home'/></Link>
            </div>
            <div className="nav-link">
            <Link to="about" spy={true} smooth={true} offset={-100} duration={100}>
                <FcAbout title='About'/></Link>
            </div>
            <div className="nav-link">
            <Link to='edu' spy={true} smooth={true} offset={-100} duration={100}>
                <FcReading title='Education Details'/></Link>
            </div>
            <div className="nav-link">
            <Link to='tech' spy={true} smooth={true} offset={-100} duration={100}>
                <FcSalesPerformance title='Tech Stack'/></Link>
            </div>
            <div className="nav-link">
            <Link to='project' spy={true} smooth={true} offset={-100} duration={100}>
                <FcPrint title='Projects'/></Link>
            </div>
            {/* <div className="nav-link">
            <Link to='work' spy={true} smooth={true} offset={-100} duration={100}>
